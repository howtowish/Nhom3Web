                ...
                <div class="panel-body form-horizontal payment-form">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12 text-right">
                            ...
                            <script>
                            function myFunction() {
                                alert("Bạn đã thêm mới một chương trình đào tạo!");
                            }
                            </script>
                        </div>
                    </div>
