...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-md-9" style="float:right">
            <h3 style="color: red">Sửa chương trình đào tạo</h3>
            <div class="panel panel-default">
             <form action="SuaLopHoc" method="post">
                <c:forEach items="${LayLop }"  var="b">
                <div class="panel-body form-horizontal payment-form">
                
                    <div class="form-group">
                        <label for="concept" class="col-sm-3 control-label">Mã lớp</label>
                        <div class="col-sm-9">
                            <input type="hidden" class="form-control" id="concept" name="malop" value="${b.malop}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="description" class="col-sm-3 control-label">Mã chương trình đào tạo</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="description" name="ctdt" value="${b.ctdt }">
                        </div>
                    </div> 
                    <div class="form-group">
                        <label for="amount" class="col-sm-3 control-label">Thời khoá biểu</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="amount" name="thoigian" value="${b.thoigian}">
                        </div>
                    </div>
                     <div class="form-group">
                        <label for="amount" class="col-sm-3 control-label">Ngày khai giảng</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="amount" name="ngaykhaigiang" value="${b.ngaykhaigiang}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="status" class="col-sm-3 control-label">Phòng học</label>
                        <div class="col-sm-9">
                            <select class="form-control" id="status" name="phonghoc" value="${b.phonghoc }">
                     ...
                     <div class="form-group">
                        <label for="amount" class="col-sm-3 control-label">Thời gian học</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="amount" name="thoigianhoc" value="${b.thoigianhoc}">
                        </div>
                    </div>
                    <div class="form-group">
