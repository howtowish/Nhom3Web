...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-md-9" style="float:right">
            ...
            <div class="panel panel-default">
             <form action="SuaCCDT" method="post">
            <c:forEach items="${LAYCTDT}" var="b">
                <div class="panel-body form-horizontal payment-form">
                    <div class="form-group">
                        <label for="concept" class="col-sm-3 control-label">Mã chương trình đào tạo</label>
                        <div class="col-sm-9">
                            <input type="hidden" class="form-control" id="concept" name="maccdt" value="${b.maccdt}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="description" class="col-sm-3 control-label">Tên chương trình đào tạo</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="description" name="tenccdt" value="${b.tenctdt }">
                        </div>
                    </div> 
                    <div class="form-group">
                        <label for="amount" class="col-sm-3 control-label">Học phí</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="amount" name="hocphi" value="${b.hocphi}">
                        </div>
                    </div>
                    <div class="form-group">
