...
<script>
function myFunction(mccdt) {
    if (confirm("Chọn ok nếu muốn xóa!") == true) {
    	window.location.replace("XOACCDT?id="+ mccdt);
    } else {
    	window.location.replace("CCDT");  
    }
}
</script>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-md-9" style="float:right">
            <h3 style="color:red">Danh mục chương trình đào tạo</h3>
        <div class="table-responsive">
              ...
              <table class="table table-bordred table-striped">
                   ...
                   <c:forEach items="${CCDT}" var="b">
                 <tr>
                    <td>${b.maccdt}</td>
                    <td>${b.tenctdt}</td>
                    <td> ${b.hocphi}</td>
                    <td><a href="SuaCCDT?id=${b.maccdt}"><p data-placement="top" data-toggle="tooltip" title="Edit"><button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-pencil"></span></button></p></a></td>
                    <td><p data-placement="top" data-toggle="tooltip" title="Edit"><button onclick="myFunction('${b.maccdt}')" class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="glyphicon glyphicon-trash"></span></button></p></td>
                </tr>
                </c:forEach>
                        </table>
