...
<script>
function myFunction(tendangnhap){
    ...
    <div class="row">
        ...
        <div class="table-responsive">
              ...
              <table class="table table-bordred table-striped">
                   ...
                   <c:forEach items="${quyenhan}" var="b">
                 <tr>
                    <td>${b.tendangnhap}</td>
                    <td>${b.quyenhan}</td>
                    <c:if test="${b.tendangnhap != user}">
                    <td><button onclick="myFunction('${b.tendangnhap}')" class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit">Thay đổi</button></td>
                    </c:if>
                    <c:if test="${b.tendangnhap == user}">
                        <td></td>
                    </c:if>
      ...
      <!-- Modal content-->
      <form action="ThayDoiQuyenHan" method="post">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title" style="color: red;">Cập nhật quyền hạn</h4>
        </div>
        <div class="modal-body">
            <label for="concept" class="col-sm-3 control-label" style="color: red;">Tên tài khoản</label>         
            <input type="text" class="form-control" id="tendangnhap" name="tendangnhap" >
             
            <label for="concept" class="col-sm-3 control-label" style="color: red;">Quyền hạn</label>
            <select class="form-control" id="status" name="quyenhan">
                <option>Admin</option>
                 <option>User</option>
            </select>
        </div>
