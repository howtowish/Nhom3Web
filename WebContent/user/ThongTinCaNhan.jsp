...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-9 col-md-9" style="float:right">
            <h3 style="color: red">Thay đổi thông tin cá nhân</h3>
            <div class="panel panel-default">
                <div class="panel-body form-horizontal payment-form">
                 <c:forEach items="${ThongTin}" var="a">
                    <div class="form-group">
                        <label for="concept" class="col-sm-3 control-label">Họ và tên</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="concept" name="hoten" value="${a.hoten }">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="description" class="col-sm-3 control-label">số điện thoại</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="description" name="sdt" value="${a.sdt }">
                        </div>
                    </div> 
                    <div class="form-group">
                        <label for="description" class="col-sm-3 control-label">Địa chỉ</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="description" name="diachi" value="${a.diachi }">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="description" class="col-sm-3 control-label">Nghề nghiệp</label>
                        <div class="col-sm-9">
