...
<title>Trung tâm tin học Cybers</title>
</head>
<body>
<!-- slide quang cao-->
        ...
        <div class="col-sm-9 col-md-9" style="float:right">
            ...
            <div class="panel panel-default">
                ...
                <div class="form-group">
                        <label for="concept" class="col-sm-3 control-label">Tên đăng nhập</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="concept" name="username" value="${user}" disabled>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="concept" class="col-sm-3 control-label">Mật khẩu cũ</label>
                        <div class="col-sm-9">
                            <input type="password" class="form-control" id="concept" name="pass" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="description" class="col-sm-3 control-label">Mật khẩu mới</label>
                        <div class="col-sm-9">
                            <input type="password" class="form-control" id="description" name="pass2" >
                        </div>
                    </div> 
                    <div class="form-group">
                        <label for="description" class="col-sm-3 control-label">Nhập lại mật khẩu</label>
                        <div class="col-sm-9">
                            <input type="password" class="form-control" id="description" name="repass2" >
                    ...
                    <div class="form-group">
                        <div class="col-sm-12 text-right">
                            ...
                            <script>
                            function myFunction() {
                                confirm ("Bạn đã đăng nhập thành công chọn ok để đăng xuất và đăng nhập lại với mật khẩu mới!");
                            }
                            </script>
                        </div>
                    </div>
